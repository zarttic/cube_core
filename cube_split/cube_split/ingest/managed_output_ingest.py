...
def ingest_managed_output(
    ...
    *,
    ...
    snapshot = _load_snapshot(conn, dataset_id, output_dataset_id, output_version, scene_ids, band_unit_ids)
    ...
    params = {
        ...
        "band_unit_ids": list(band_unit_ids),
        "managed_output": True,
    }
...
def _load_snapshot(
    ...
    with conn.cursor(row_factory=dict_row) as cur:
        ...
        cur.execute(
            ...
            "JOIN scene_bands sb ON sb.asset_id=i.source_asset_id AND sb.band_code=i.band_code "
            ...
            "WHERE i.dataset_id=%s AND i.output_version=%s AND sb.scene_id=ANY(%s) "
            "AND (%s::text[]='{}'::text[] OR sb.band_unit_id=ANY(%s)) ORDER BY i.output_id",
