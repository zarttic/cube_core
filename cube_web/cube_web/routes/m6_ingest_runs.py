...
from cube_web.services.m6_ingest_contracts import CancelIngestRun, RetryIngestScenes
...
def create_m6_ingest_runs_router(service: IngestRunService) -> APIRouter:
