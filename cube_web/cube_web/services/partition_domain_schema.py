...
def schema_statements() -> tuple[str, ...]:
    ...
    return (
        ...
        """CREATE TABLE IF NOT EXISTS partition_quality_errors (
          ...
          rule_code TEXT NOT NULL, source_asset_id TEXT, band_code TEXT, tile_id TEXT, index_id TEXT, output_id TEXT,
        ...
        """ALTER TABLE partition_quality_errors ADD COLUMN IF NOT EXISTS band_code TEXT""",
