...
class M6StrictModel(BaseModel):
    model_config = ConfigDict(extra="forbid", frozen=True)


class SceneDatasetSelection(M6StrictModel):
...
class ScenePartitionRunRequest(M6StrictModel):
...
class ScenePartitionRunResponse(M6StrictModel):
...
class LoadBatchSceneQuery(M6StrictModel):
