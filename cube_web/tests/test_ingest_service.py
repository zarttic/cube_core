...
def test_band_selection_changes_ingest_idempotency_identity() -> None:
    first = scene_idempotency_key("dataset-a", "scene-a", "output-v1", ("band-a-b01",))
    second = scene_idempotency_key("dataset-a", "scene-a", "output-v1", ("band-a-b02",))
